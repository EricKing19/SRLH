...
parser = argparse.ArgumentParser (description="SRLH demo random")
...
parser.add_argument('--train_ndcg', type=int, default=10,
...
if __name__ == "__main__":
    ...
    logdir = '-'.join (['log/run_ori5', opt.dataname, date])
    _logging ()
    _record ()
