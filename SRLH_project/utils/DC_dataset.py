...
def encoding_onehot(target, nclasses=10):
    ...
    target_onehot = target_onehot.view(nclasses)
...
class single_dataset(Dataset):
    def __init__(self, data_name, img_filename, label_filename, transform=None, nclass=10):
        self.data_path = '/data/dacheng/Datasets/' + data_name + '/'
        self.transform = transform
    ...
    def __getitem__(self, index):
        ...
        if self.transform is not None:
            img = self.transform (img)
        label_ = torch.LongTensor ([self.label[index]])
        label = encoding_onehot (label_,self.nclass)
...
class multi_dataset(Dataset):
    def __init__(self, data_name, img_filename, label_filename, transform=None):
        self.data_path = '/data/dacheng/Datasets/' + data_name + '/'
        self.transform = transform
        img_filepath = os.path.join(self.data_path, img_filename)
        fp = open(img_filepath, 'r')
...
class CIFAR10(Dataset):
    data_path = '/data/dacheng/Datasets/CIFAR10/'
...
class CIFAR100(CIFAR10):
    data_path = '/data/dacheng/Datasets/CIFAR100/'
...
class Mnist(Dataset):
    data_path = '/data/dacheng/Datasets/Mnist/'
    def __init__(self, img_filename, label_filename, transform=None):
        # self.img_filename = img_filename
        self.transform = transform
        # reading img file from file
...
class fashion_mnist(Mnist):
    data_path = '/data/dacheng/Datasets/fashion_mnist/'
    # def __init__(self, img_filename, label_filename, transform=None):
    #     # self.img_filename = img_filename
    #     self.transform = transform
    #     # reading img file from file
